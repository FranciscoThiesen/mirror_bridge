...
echo ""
echo "Inside container, try the hello-world example:"
echo "  cd /workspace/examples/01-hello-world"
echo "  ../../tools/mirror_bridge generate src/ --module greeter --lang python"
echo "  python3 test_greeter.py"
echo ""
